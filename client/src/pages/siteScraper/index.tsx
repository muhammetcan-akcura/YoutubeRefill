...
const services = data?.services ?? []
  ...
  if (newSite.domain && newSite.path  && newSite.categoryClass) {
    try {
      ...
      setNewSite({ domain: ".com", path: "services", categoryClass: "services-list-category-title" }) // ✅ path eklendi
  ...
  if (editingSite && newSite.domain && newSite.path && newSite.categoryClass) {
    try {
      await updateSiteMutation.mutateAsync({
        id: editingSite.id,
        ...newSite, // ✅ path dahil tüm alanlar burada
      })

      setNewSite({ domain: "", path: "", categoryClass: "" }) // ✅ path reset
      setEditingSite(null)
      setIsModalOpen(false)
    ...
    <div className="min-h-screen bg-gray-900">
      <div className="container mx-auto px-4 py-6 max-w-7xl">
        ...
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-6">
          ...
          {/* Add Button - Only show for sites tab */}
         {activeTab === "sites" && (
